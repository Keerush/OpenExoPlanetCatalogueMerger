...
request({
	...
	if (!err && response.statusCode === 200) {
		...
		var queries = [{
			...
			key: 'StarSystem',
			value: starsystemQuery
		}, {
			key: 'PlanetStar',
			value: planetstarQuery
		}];
